  ...
  <div class="container-fluid cover-container text-center d-flex flex-column">
      ...
      <form class="mx-auto" method="POST">
        ...
        <div class="form-group col-12">
          <label>Add Dog</label>
          <input type="text" class="form-control" placeholder="nameBreeding">
        ...
        <div class="form-group col-12"> 
          <label>Breed</label> 
          <input type="text" class="form-control" placeholder="Name of Breed">
        </div>
        <div class="form-group col-12"> 
          <label>Gender</label>
          <div class="radio">
            <label></label><input class="form-check-input" type="radio" name="legendRadio" id="legendRadio1" value="1">Male</label>
          </div>
          <div class="radio">
            <label><input class="form-check-input" type="radio" name="legendRadio" id="legendRadio2" value="2">Female</label>
          </div>
        </div>
